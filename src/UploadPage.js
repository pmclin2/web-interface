...
const UploadPage = () => {
  ...
  const handleFileDrop = (event) => {
    ...
    //Input sanitation
    droppedFile.name = droppedFile.name.replace(/[^a-zA-Z0-9.]/g, "_");
    droppedFile.name = droppedFile.name.replace(/_+/g, "_");
    ...
    if (droppedFile.name.length > 255) {
      alert("File name exceeds 255 characters.");
      return;
    }
  ...
  const handleFileChange = (event) => {
    ...
    selectedFile.name = selectedFile.name.replace(/[^a-zA-Z0-9.]/g, "_");
    selectedFile.name = selectedFile.name.replace(/_+/g, "_");
      ...
      for (let i = 0; i < files.length; i++) {
        const item = {
          ...
          Item: {
            ...
            name: {
              S: fileDescriptions[i] === "" ? fileName : fileDescriptions[i],
            },
            version: { S: "1.0" },
            ratings: {
              S: '{ "URL": "github.com/pinojs/pino", "NET_SCORE" : 0.52, "RAMP_UP_SCORE" : 0.5341, "CORRECTNESS_SCORE" : 0.0816, "BUS_FACTOR_SCORE" : 0.9471, "RESPONSIVE_MAINTAINER_SCORE" : 0.2, "LICENSE_SCORE" : 1, "DEPENDENCE_SCORE" : 0.5, "REVIEWED_CODE_SCORE" : 0.3,}',
            },
          },
        };
