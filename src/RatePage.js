...
const RatePage = () => {
  ...
  const ratingMock =
    '{ "URL": "github.com/pinojs/pino", "NET_SCORE" : 0.52, "RAMP_UP_SCORE" : 0.5341, "CORRECTNESS_SCORE" : 0.0816, "BUS_FACTOR_SCORE" : 0.9471, "RESPONSIVE_MAINTAINER_SCORE" : 0.2, "LICENSE_SCORE" : 1, "DEPENDENCE_SCORE" : 0.5, "REVIEWED_CODE_SCORE" : 0.3,}';
  const ratings = [
    "NET SCORE",
    "RAMP UP SCORE",
    "CORRECTNESS SCORE",
      ...
      >
        ...
        <Container maxWidth="lg">
          ...
          >
            <Button
              variant="contained"
              onClick={() => handleRateButtonClick(urlInput)}
